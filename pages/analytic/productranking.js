...
const ProductRanking = () => {
  ...
  const CustomSalesCountRow = ({ row }) => {
    ...
    const fetchModelSalesCountDetailData = async (startDate, endDate, modelName, categoryName) => {
      ...
      let tempCacheData = modelSalesCountCachePaginationData;
      ...
      setModelSalesCountCachePaginationData(tempCacheData);
      setOpen(true);
      setLoading(false);
    };
  ...
  const CustomCategorySalesCountRow = ({ row }) => {
    ...
    const fetchCategorySalesCountDetailData = async (startDate, endDate, productCategoryName) => {
      ...
      let tempCacheData = categorySalesCountCachePaginationData;
      ...
      setCategorySalesCountCachePaginationData(tempCacheData);
      setOpen(true);
      setLoading(false);
    };
