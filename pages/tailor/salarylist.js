...
import moment from '../../src/utils/moment.js';
import { getCurrentTime } from '../../src/utils/momentSystem.js';
  ...
  useEffect(() => {
    const fetchTailorSalaryData = async (startDate, endDate, userid) => {
      ...
      processedData.Data.forEach(function (dataItem) {
        ...
        object.TailorSalaryID = dataItem.InvoiceID;
				object.FullName = dataItem.TailorName;
				object.FeeDate = dataItem.InvoiceDate;
				object.EmbroideryFee = Intl.NumberFormat('id').format(dataItem.TotalBordir);
    ...
    if (fetchActive == true) {
      ...
      fetchTailorSalaryData(startDate, endDate, userid);
